...
#define RBdup               (RC + 1)
    {
        6, 12, 0, ARC_OPERAND_IR | ARC_OPERAND_DUPLICATE,
        insert_rb, extract_rb
    },
...
#define RB_Sdup             (RB16 + 1)
    {
        4, 8, 0, ARC_OPERAND_IR | ARC_OPERAND_DUPLICATE,
        insert_rbs, extract_rbs
    },
...
#define SIMM11_A32_7_S      (UIMM3_13R_S + 1)
    {
        ...
        | ARC_OPERAND_TRUNCATE, insert_simm11_a32_7_s,
...
#define UIMM5_11_S          (UIMM6_13_S + 1)
    {
        ...
        insert_uimm5_11_s, extract_uimm5_11_s
    },
...
#define SIMM21_A16_5        (UIMM6_8 + 1)
    {
        ...
        ARC_OPERAND_TRUNCATE | ARC_OPERAND_PCREL, insert_simm21_a16_5,
...
#define SIMM25_A16_5        (SIMM21_A16_5 + 1)
    {
        ...
        ARC_OPERAND_TRUNCATE | ARC_OPERAND_PCREL,
...
#define SIMM10_A16_7_Sbis   (SIMM10_A16_7_S + 1)
    {
        ...
        insert_simm10_a16_7_s, extract_simm10_a16_7_s
    },
...
#define SIMM7_A16_10_S      (SIMM10_A16_7_Sbis + 1)
    {
        ...
        insert_simm7_a16_10_s, extract_simm7_a16_10_s
    },
...
#define SIMM13_A32_5_S      (SIMM25_A32_5 + 1)
    {
        ...
        ARC_OPERAND_TRUNCATE | ARC_OPERAND_PCREL,
        insert_simm13_a32_5_s, extract_simm13_a32_5_s
    },
...
#define SIMM11_A32_13_S     (UIMM5_A32_11_S + 1)
    {
        11, 0, 0, ARC_OPERAND_SIGNED | ARC_OPERAND_ALIGNED32 |
        ARC_OPERAND_TRUNCATE, insert_simm11_a32_13_s,
...
#define NPS_BITOP_DST_POS_SZ (NPS_BITOP_SIZE + 1)
    {
        5, 0, 0, ARC_OPERAND_UNSIGNED, insert_nps_dst_pos_and_size,
...
#define NPS_BITOP_UIMM8     (NPS_BITOP_SIZE_2B + 1)
    {
        8, 0, 0, ARC_OPERAND_UNSIGNED, insert_nps_bitop_uimm8,
